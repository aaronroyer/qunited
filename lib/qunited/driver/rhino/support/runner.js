// Runs QUnit tests with Envjs and outputs test results as an array of data
// serialized in JSON format.
//
// The first argument should be the lib directory containing common QUnited
// dependencies. The second argument is the directory containing Rhino driver
// specific dependencies. The next arguments are source JavaScript files to
// test, until "--" is encountered. After the "--" the rest of the arguments
// are QUnit test files.
//
// Example:
...
QUnited.testFiles.forEach(function(file) {
	...
	for (i = 0; i < results.length; i++) {
		// Beginning and end tokens should match the constants in QUnited::Driver::Base
